import { r as reactExports, j as jsxRuntimeExports, u as useLanguage, L as Link, l as languageNames } from "./index-ib-RthyM.js";
import { B as Badge, T as TrendingUp, G as Globe } from "./Navbar-BxJ_VEM-.js";
...
const Battery = createLucideIcon("battery", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-background/90 via-background/70 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background/95 via-background/40 to-transparent" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-primary/20 blur-3xl pointer-events-none animate-pulse-slow" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/3 left-1/5 w-64 h-64 rounded-full bg-accent/15 blur-3xl pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center lg:text-left", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.h1,
              {
                ...
                children: headlineLines.map((line) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { className: "w-4 h-4 text-primary" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t.heroSecondaryText })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block text-border", children: "|" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-medium", children: "10,000+ Farmers Empowered" })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(LiveSensorPreview, {})
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs tracking-widest uppercase", children: "Scroll to Explore" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  animate: { y: [0, 6, 0] },
...
function LiveSensorPreview() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-3xl p-6 border border-primary/30 shadow-glass-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Live Sensor Feed" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground mt-0.5", children: "Field Block A — North Zone" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-xs bg-primary/20 text-primary px-3 py-1 rounded-full font-medium", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 mb-4", children: [
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `font-bold text-lg ${s.color}`, children: s.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: s.label })
          ]
        },
        s.label
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass rounded-xl p-3 border border-accent/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-accent/20 flex items-center justify-center text-lg", children: "☀️" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Solar Battery" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-accent font-bold shrink-0", children: "88%" })
          ] })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 -right-4 glass px-3 py-2 rounded-xl text-xs font-bold text-accent border border-accent/30 shadow-glow-accent", children: "✓ All Systems Nominal" })
  ] });
}
const sensorCards = [
  {
    icon: Droplets,
    title: "Soil Moisture",
    description: "Continuous volumetric water content monitoring using capacitive sensors buried at root depth for precise irrigation decisions.",
    metric: "± 2% Accuracy",
    unit: "% VWC",
    value: "68",
    color: "text-sky-400",
  ...
  },
  {
    icon: Leaf,
    title: "NPK Levels",
    description: "Electrochemical ion-selective sensors measuring Nitrogen, Phosphorus, and Potassium concentrations — key macro-nutrients for crop health.",
    metric: "N:P:K Ratio",
    unit: "mg/kg",
    value: "140:45:30",
    color: "text-primary",
  ...
  },
  {
    icon: FlaskConical,
    title: "pH Balance",
    description: "Glass electrode pH sensors detect soil acidity or alkalinity in real-time, enabling lime or sulfur applications before crop stress occurs.",
...
function IoTSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-muted/30" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary/30 to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary/30 to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "glass border-primary/30 text-primary mb-4 px-4 py-1.5 font-medium gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "w-3.5 h-3.5" }),
                  "Solar-Powered IoT Hardware"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl sm:text-5xl font-bold text-foreground mb-4", children: "The IoT Tech Stack" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed", children: "Our ruggedized field sensors transmit data every 15 minutes over LoRaWAN — even in remote areas with no mobile internet." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 mb-12", children: sensorCards.map((card, i) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-foreground mb-2", children: card.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-5", children: card.description }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1", children: "Current Reading" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: card.unit })
                        ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6 text-center divide-y sm:divide-y-0 sm:divide-x divide-white/10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 sm:py-0 py-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-2xl bg-accent/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "w-6 h-6 text-accent" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-foreground text-xl", children: "Solar-Powered" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Zero electricity cost in the field" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 sm:py-0 py-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-2xl bg-primary/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Battery, { className: "w-6 h-6 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-foreground text-xl", children: "30-Day Backup" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Operates through extended cloud cover" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 sm:py-0 py-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-2xl bg-sky-500/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "w-6 h-6 text-sky-400" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-foreground text-xl", children: "LoRaWAN Mesh" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "15 km range, works without mobile data" })
                  ] })
                ] })
              ] })
            }
...
const bigStats = [
  {
    ...
    description: "Farmers using FarmTech AI's precision irrigation and NPK guidance consistently harvest 25 to 35% more per acre than regional averages.",
    color: "text-primary",
    bg: "bg-primary/10",
  ...
  },
  {
    ...
    value: "128%",
    label: "Income Growth",
    description: "By combining better yields, AI-driven market timing, and reduced input costs, enrolled farmers have more than doubled their net income.",
    color: "text-accent",
    bg: "bg-accent/10",
...
function MetricsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-muted/30" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-accent/30 to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-accent/30 to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 top-1/2 -translate-y-1/2 w-64 h-64 bg-primary/10 rounded-full blur-3xl pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-0 top-1/2 -translate-y-1/2 w-64 h-64 bg-accent/10 rounded-full blur-3xl pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              className: "text-center mb-16",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "glass border-accent/30 text-accent mb-4 px-4 py-1.5 font-medium gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl sm:text-5xl font-bold text-foreground mb-4", children: [
                  "Real Numbers, ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Real Farmers" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed", children: "Our impact data comes from 10,000+ farmers across 8 Indian states, independently verified by partner organizations." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 mb-10", children: bigStats.map((stat, i) => {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `w-8 h-8 ${stat.color}` })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm uppercase tracking-wider mb-1", children: stat.label }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: stat.description })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 h-2 rounded-full bg-white/10 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.div,
                    {
                      initial: { width: 0 },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-0 divide-y lg:divide-y-0 lg:divide-x divide-white/10", children: supportingStats.map((s, i) => {
                const Icon = s.icon;
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `w-6 h-6 ${s.color} mb-1` }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `font-display text-3xl font-bold ${s.color}`, children: s.value }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl sm:text-5xl font-bold text-foreground mb-4", children: [
                  "Built for ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "Every" }),
                  " Farmer"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed", children: "Agriculture crosses every language barrier. Our platform speaks the farmer's mother tongue — from the Gangetic plains to the Deccan plateau." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5", children: langCards.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 32 },
              whileInView: { opacity: 1, y: 0 },
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `w-full text-left glass-card rounded-3xl border transition-smooth hover:scale-[1.02] group ${language === card.lang ? "border-accent/50 shadow-glow-accent bg-accent/5" : "border-white/15 hover:border-primary/30"}`,
                  "data-ocid": `lang-card-${card.lang}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: card.flag }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-foreground leading-none", children: card.nativeName }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: languageNames[card.lang] })
                        ] })
                      ] }),
                      language === card.lang && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-5 h-5 text-accent shrink-0" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-3 border border-white/10 mb-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm mb-0.5", children: card.sampleTitle }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-3", children: card.sampleSub }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-primary/15 rounded-lg p-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: card.soilLabel }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-primary text-sm", children: card.soilValue })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-accent/15 rounded-lg p-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: card.phLabel }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-accent text-sm", children: card.phValue })
                        ] })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: `text-center py-2 rounded-xl text-xs font-semibold transition-smooth ${language === card.lang ? "bg-accent/20 text-accent" : "bg-primary/15 text-primary group-hover:bg-primary/25"}`,
                        children: card.sampleCta
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-3 text-center", children: card.stateLabel })
                  ]
                }
              )
            },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: "Click any language card" }),
                " ",
                "above to switch the entire interface. Currently displaying in",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-semibold", children: languageNames[language] }),
                "."
              ] })
            }
          )
...
const partners = [
  {
    name: "HDFC Bank",
    role: "Credit Partner",
    description: "Farmers get instant Kisan Credit Card access and crop-linked microloans with no collateral required — disbursed directly to their accounts.",
    icon: CreditCard,
  ...
  },
  {
    ...
    description: "Parametric crop insurance triggers automatic payouts when IoT sensors detect drought, flooding, or disease events — no claim paperwork needed.",
    icon: Shield,
  ...
  },
  {
    name: "ITC / BigBasket",
    role: "Market Linkage",
    description: "Verified quality scores from our sensors unlock premium pricing on ITC's e-Choupal network and BigBasket's direct-from-farm sourcing platform.",
    icon: ShoppingCart,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl sm:text-5xl font-bold text-foreground mb-4", children: [
                  "From Field to ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "Financial Freedom" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed", children: "We connect farmers to India's largest financial and agri-commerce institutions — turning data into credit, insurance, and market access." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 mb-12", children: partners.map((partner, i) => {
              ...
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `w-7 h-7 ${partner.color}` })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Badge,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-foreground mb-0.5", children: partner.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-sm font-semibold ${partner.color} mb-3`, children: partner.role }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-5", children: partner.description }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: `glass rounded-xl px-4 py-3 border ${partner.border} flex items-center justify-between`,
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-bold text-sm ${partner.color}`, children: partner.feature }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            ArrowRight,
                            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-base max-w-2xl mx-auto", children: [
                  "Our growing ecosystem spans",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: "12+ institutional partners" }),
                  " ",
                  "— from input suppliers and FPOs to state government agri departments. Join the network that's rebuilding rural India's value chain."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { className: "mt-6 flex flex-wrap justify-center items-center gap-3", children: [
                  "NABARD",
                  "e-Choupal",
                  "Grameen Bank",
                  "APMC Digital",
...
function Landing() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(IoTSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MultilingualSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MetricsSection, {}),
